...
@warning_ignore("unused_signal")
signal treaty_changed(faction_a: FactionData, faction_b: FactionData, relation: int)
@warning_ignore("unused_signal")
signal betrayal_committed(betrayer: FactionData, target: FactionData)
@warning_ignore("unused_signal")
signal vassalage_started(vassal: FactionData, overlord: FactionData)
@warning_ignore("unused_signal")
signal tribute_paid(vassal: FactionData, overlord: FactionData)
@warning_ignore("unused_signal")
